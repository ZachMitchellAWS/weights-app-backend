function Privacy() {
  return (
    <div className="legal-page">
      ...
      <p>Our Privacy Policy was last updated on June 23, 2026.</p>
      ...
      <li>
      <p><strong>Privacy Policy</strong> means this document that describes how Anthroverse LLC collects, uses, processes, and discloses personal information from Users of the Service. The Privacy Policy can be found at <a href="/privacy">liftthebull.io/privacy</a>.</p>
      </li>
      ...
      <p>Under GDPR, You can be referred to as the Data Subject or as the ser as You are the individual using the Service.</p>
      </li>
      ...
      <p>Usage Data may include information such as Your Device's Internet Protocol address (e.g., IP address), browser type, browser version, the pages of Our Service or Website that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers, and other diagnostic data.</p>
      <p>When You access the Service through the Application on a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device's unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers, and other diagnostic data.</p>
      <p>We may also collect information that Your browser sends whenever You visit Our Website or use the Service through the Application on any device.</p>
      <h3>Use of Your Personal Data</h3>
      <p>Anthroverse LLC may use Personal Data for the following purposes:</p>
      <ul>
      <li>
      ...
      <li><strong>With analytics and advertising service providers:</strong> We share certain information with Google (Firebase Analytics and Google Ads) to perform the analytics and conversion-measurement services described in the &quot;Detailed Information on the Processing of Your Personal Data&quot; section.</li>
      ...
      <p>Our Service gives You the ability to delete certain information about You from within the Service.</p>
      ...
      <h3>Analytics</h3>
      <p>We use <strong>Google Firebase Analytics</strong> to collect anonymized app usage events and standard device and operating-system metadata so that We can understand how the Application is used and improve it over time. Firebase Analytics processes this data subject to Google’s privacy practices. For more information, please review Google’s Privacy Policy at <a href="https://policies.google.com/privacy" rel="external nofollow noopener" target="_blank">policies.google.com/privacy</a> and the Firebase privacy and security information at <a href="https://firebase.google.com/support/privacy" rel="external nofollow noopener" target="_blank">firebase.google.com/support/privacy</a>.</p>
      <h3>Advertising and Conversion Measurement</h3>
      <p>We advertise the Application through <strong>Google Ads</strong> campaigns. Attribution and conversion measurement are performed in two ways: through Apple’s SKAdNetwork framework, which delivers anonymized install postbacks to ad networks, and through first-party conversion events collected by Firebase Analytics and forwarded to Google Ads for the sole purpose of measuring the effectiveness of Our own advertising campaigns. We do not share Your data with Google or any other ad network for cross-app retargeting or third-party behavioral advertising, and We do not display third-party advertisements inside the Application. Google’s use of data in these services is governed by their Privacy Policy at <a href="https://policies.google.com/privacy" rel="external nofollow noopener" target="_blank">policies.google.com/privacy</a>.</p>
      ...
      <p>We may use Your Personal Data to send You newsletters, marketing or promotional materials, and other information that might be of interest to You. You have the option to opt out of receiving any, or all, of these communications from Us by following the unsubscribe link or instructions provided in any email We send or by directly contacting Us.</p>
      <p>Our email marketing efforts are conducted using internal tools and resources provided by Our cloud services infrastructure, which adhere to strict privacy standards to protect Your information. We commit to maintaining Your privacy and ensuring the security of Your Personal Data in all Our marketing activities.</p>
      <h3>Payments</h3>
      ...
      <ul>
      <li>By visiting this page on our website: <a href="/privacy"> https://liftthebull.io/privacy</a></li>
      </ul>
      ...
      <p>As defined in the CCPA/CPRA, &quot;sell&quot; and &quot;sale&quot; mean selling, renting, releasing, disclosing, disseminating, making available, transferring, or otherwise communicating orally, in writing, or by electronic or other means, a Consumer's personal information by the Business to a third party for valuable consideration. This means that We may have received some kind of benefit in return for sharing personal information, but not necessarily a monetary benefit.</p>
      <p>We do not sell personal information as the term sell is commonly understood. We do allow Service Providers to use Your personal information for the business purposes described in Our Privacy Policy,  and these may be deemed a sale under CCPA/CPRA.</p>
      <p>Data shared with Google for first-party conversion measurement of Our own advertising campaigns is used solely to measure the effectiveness of those campaigns. This does not constitute &quot;sharing&quot; for cross-context behavioral advertising as defined by the CPRA.</p>
      ...
      <ul>
      <li>By email at <a href="mailto:support@liftthebull.io">support@liftthebull.io</a></li>
      </ul>
